...
class Routes {
  ...
  static const newmanuscriptView = '/newmanuscript-view';

  static const manuscriptView = '/manuscript-view';
...
class StackedRouter extends _i1.RouterBase {
  final _routes = <_i1.RouteDef>[
    ...
    _i1.RouteDef(
      Routes.newmanuscriptView,
      page: _i6.NewmanuscriptView,
    ),
    _i1.RouteDef(
      Routes.manuscriptView,
      page: _i7.ManuscriptView,
    ),
    _i1.RouteDef(
      Routes.profileView,
...
class ManuscriptViewArguments {
  const ManuscriptViewArguments({
    this.key,
    this.manuscriptId,
  });
  ...
  @override
  String toString() {
    return '{"key": "$key", "manuscriptId": "$manuscriptId"}';
  }

  @override
  bool operator ==(covariant ManuscriptViewArguments other) {
    if (identical(this, other)) return true;
    return other.key == key && other.manuscriptId == manuscriptId;
  }

  @override
  int get hashCode {
    return key.hashCode ^ manuscriptId.hashCode;
  }
}
...
extension NavigatorStateExtension on _i11.NavigationService {
  ...
  Future<dynamic> navigateToNewmanuscriptView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return navigateTo<dynamic>(Routes.newmanuscriptView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> navigateToManuscriptView({
    ...
    return navigateTo<dynamic>(Routes.manuscriptView,
        arguments:
            ManuscriptViewArguments(key: key, manuscriptId: manuscriptId),
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> replaceWithNewmanuscriptView([
    int? routerId,
    bool preventDuplicates = true,
    Map<String, String>? parameters,
    Widget Function(BuildContext, Animation<double>, Animation<double>, Widget)?
    ...
    return replaceWith<dynamic>(Routes.newmanuscriptView,
        id: routerId,
        preventDuplicates: preventDuplicates,
        parameters: parameters,
        transition: transition);
  ...
  Future<dynamic> replaceWithManuscriptView({
    ...
    return replaceWith<dynamic>(Routes.manuscriptView,
        arguments:
            ManuscriptViewArguments(key: key, manuscriptId: manuscriptId),
        id: routerId,
        preventDuplicates: preventDuplicates,
